...
temp += '<div id="button"><a href="#"><div id="send">Send</div></a></div>'
		...
		$("#animDiv").html(temp);
		 ...
		 /*if(navigator.userAgent.indexOf('Mac') > 0 && navigator.userAgent.toLowerCase().indexOf("ipad") < 0) {
 

var elementStyle8 = document.getElementById("com8").style;
elementStyle8.position = "relative";
elementStyle8.top = "-246px";
elementStyle8.left = "347px";

var elementStyle7 = document.getElementById("com7").style;
elementStyle7.position = "relative";
elementStyle7.top = "-131px";
elementStyle7.left = "334px";

var elementStyle6 = document.getElementById("com6").style;
elementStyle6.position = "relative";
elementStyle6.top = "-18px";
elementStyle6.left = "285px";

var elementStyle5 = document.getElementById("com5").style;
elementStyle5.position = "relative";
elementStyle5.top = "67px";
elementStyle5.left = "215px";

var elementStyle4 = document.getElementById("com4").style;
elementStyle4.position = "relative";
elementStyle4.top = "123px";
elementStyle4.left = "137px";

var elementStyle3 = document.getElementById("com3").style;
elementStyle3.position = "relative";
elementStyle3.top = "147px";
elementStyle3.left = "72px";

var elementStyle2 = document.getElementById("com2").style;
elementStyle2.position = "relative";
elementStyle2.top = "145px";
elementStyle2.left = "24px";
...
var elementStyle8 = document.getElementById("com8").style;
elementStyle8.position = "relative";
elementStyle8.top = "-243px";
elementStyle8.left = "347px";

var elementStyle7 = document.getElementById("com7").style;
elementStyle7.position = "relative";
elementStyle7.top = "-128px";
elementStyle7.left = "334px";

var elementStyle6 = document.getElementById("com6").style;
elementStyle6.position = "relative";
elementStyle6.top = "-15px";
elementStyle6.left = "285px";
