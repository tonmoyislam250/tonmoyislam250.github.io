...
var animation1 = function(data)
{
	...
	temp += '<div id="container"><div id="imagecontainer"><img id="mainImg" src="10_1_3_4.png" height="330" width="455" /><img src="Switch-workgroup.png" height="33" width="68" id="switch"/></div></div>';
	...
	tl.append([ new TweenLite(envelop,.1,{css:{opacity:0}}),
				//new TweenLite([envelop1,envelop2,envelop3,envelop4,envelop5],.1,{css:{opacity:1}}),
				new TweenLite(envelop1,2,{css:{opacity:1,left:332,top:29,scale:.7}}),
				new TweenLite(envelop2,2,{css:{opacity:1,left:361,top:57,scale:.7}}),
				new TweenLite(envelop3,2,{css:{opacity:1,left:366,top:84,scale:.7}}),
				new TweenLite(envelop4,2,{css:{opacity:1,left:362,top:123,scale:.7}}),
				new TweenLite(envelop5,2,{css:{opacity:1,left:330,top:129,scale:.7}}),
