...
function getData() 
{
	...
	var slide_buttons = [{compId:"ID_Button01",
						...
						size:11,
						textAlign:"center"}];
	var slide_feedback = [{correctTitleId:"ID_titleCorrect",x:17,y:142,size:11,width:160,color:"#573359",isBold:true},
						{correctBodyId:"ID_correctText",x:18,y:170,size:11,width:180},
						{wrongTitleId:"ID_titleIncorrect",x:17,y:142,size:11,width:160,color:"#573359",isBold:true},					
						{wrongBodyId:"ID_IncorrectText",x:18,y:170,size:11,width:180},
						{imageName:"textbox.jpg",x:-1,y:135},
						{closeBtn:true, x:174,y:137}]
